...
const Navbar = () => {
  const { openSidebar, setContextPageId } = useGlobalContext();
  ...
  return (
    ...
    >
      <div className=" flex justify-between w-[90vw] max-w-[1120px] min-[992px]:grid min-[992px]:self-stretch min-[992px]:grid-cols-[auto_1fr] ">
